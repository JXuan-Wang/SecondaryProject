package org.example.systemserver.config.listener;
...
public class UploadDataListener implements ReadListener<TClue> {
     ...
     * @param demoDAO
     */
    public UploadDataListener(TClueMapper demoDAO,String token) {
    ...
    private void saveData() {
        ...
        demoDAO.saveClue(cachedDataList);
        log.info("存储数据库成功！");
    }
}