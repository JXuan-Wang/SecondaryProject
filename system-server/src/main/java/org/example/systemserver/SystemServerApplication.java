package org.example.systemserver;
...
@MapperScan(basePackages = {"org.example.systemserver.mapper"})
public class SystemServerApplication implements CommandLineRunner {
